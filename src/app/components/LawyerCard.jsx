...
export default function LawyerCard({ lawyer }) {
  return (
    <motion.div
      whileHover={{ y: -6 }} // স্কেল বড় না করে মডার্ন কার্ডের মতো একটু উপরে উঠবে
    ...
    >
      ...
      <div className="relative w-full h-56 bg-gray-100 overflow-hidden">
        ...
        />
        {/* Availability Badge inside the Image */}
      ...
      <div className="p-5 flex flex-col flex-grow justify-between">
        <div>
          ...
          <p className="text-gray-600 text-sm mb-5 line-clamp-2 leading-relaxed">
            {lawyer.bio || 'Provides expert professional legal consultation and representation services.'}
          </p>
        </div>
        ...
        <div className="mt-auto pt-4 border-t border-gray-50">
          <div className="flex justify-between items-center mb-4">
            <div>
              <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Hourly Rate</p>
            ...
            {lawyer.totalHires && (
              <div className="text-right">
                <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Total Hires</p>
                <p className="text-sm font-bold text-gray-700">{lawyer.totalHires} clients</p>
              </div>
            )}
          </div>
