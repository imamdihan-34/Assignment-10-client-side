      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-gray-800">
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-sm">
              Connecting trusted legal professionals with clients who need their
              expertise. Making judicial consultation smooth, reliable, and
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-gray-400">
              Stay updated through our social handles:
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-gray-800/60 border border-gray-700/50 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300 text-lg font-semibold"
              >
                f
              </a>
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-gray-800/60 border border-gray-700/50 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300 text-base font-bold"
              >
                𝕏
              </a>
              <a
        ...
        <div className="w-full max-w-3xl mx-auto bg-gradient-to-br from-gray-800/40 to-gray-900/60 border border-gray-800/80 p-6 sm:p-8 rounded-2xl my-12 text-center shadow-xl">
          ...
          <p className="text-sm text-gray-400 mb-6 max-w-md mx-auto">
            Get legal insights, case updates, and professional advice delivered
